 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.w3.org/1999/xhtml}li" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class Ol implements ToString
{

    @XmlElement(name = "li", required = true)
    protected List<Li> lis;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Li> theLis;
            theLis = (((this.lis!= null)&&(!this.lis.isEmpty()))?this.getLis():null);
            strategy.appendField(locator, this, "lis", buffer, theLis);
        }
        {
            String theId;
            theId = this.getId();

...
public class UlImpl implements ToString, Ul
{

    @XmlElement(required = true, type = LiImpl.class)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Li> theLi;
            theLi = (((this.li!= null)&&(!this.li.isEmpty()))?this.getLi():null);
            strategy.appendField(locator, this, "li", buffer, theLi);
        }
        {
            String theLanguage;
